...
<head>
    ...
    <link rel="stylesheet" media="screen, print" href="{{ asset('plugin/css/formplugins/bootstrap-datepicker/bootstrap-datepicker.css') }}">
    <link rel="stylesheet" media="screen, print" href="{{ asset('plugin/css/formplugins/bootstrap-daterangepicker/bootstrap-daterangepicker.css') }}">
