<header class="page-header" role="banner">
    ...
    <div class="ml-auto d-flex">
        ...
        <!-- app message -->
        <a href="#" class="header-icon" data-toggle="modal" data-target=".js-modal-messenger" style="display:none">
                        ...
                        <div class="custom-scroll h-100">
                            <ul class="notification">
                                <li class="unread">
                                    <a href="#" class="d-flex align-items-center">
                                        <span class="status mr-2">
                                            <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ asset('plugin/img/demo/avatars/avatar-c.png') }}')"></span>
                                        </span>
                                ...
                                <li class="unread">
                                    <a href="#" class="d-flex align-items-center">
                                        <span class="status mr-2">
                                            <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ asset('plugin/img/demo/avatars/avatar-a.png') }}')"></span>
                                        </span>
                                        <span class="d-flex flex-column flex-1 ml-1">
                                ...
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                        <span class="status status-success mr-2">
                                            <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ asset('plugin/img/demo/avatars/avatar-b.png') }}')"></span>
                                        </span>
                                        <span class="d-flex flex-column flex-1 ml-1">
                                ...
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                        <span class="status status-warning mr-2">
                                            <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ asset('plugin/img/demo/avatars/avatar-e.png') }}')"></span>
                                        </span>
                                        <span class="d-flex flex-column flex-1 ml-1">
                                ...
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                        <span class="status status-success mr-2">
                                            ...
                                            <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ asset('plugin/img/demo/avatars/avatar-h.png') }}')"></span>
                                        </span>
                                        <span class="d-flex flex-column flex-1 ml-1">
                                ...
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                        <span class="status status-success mr-2">
                                            <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ asset('plugin/img/demo/avatars/avatar-m.png') }}')"></span>
                                        </span>
                                        <span class="d-flex flex-column flex-1 ml-1">
                                ...
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                        <span class="status status-danger mr-2">
                                            <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ asset('plugin/img/demo/avatars/avatar-j.png') }}')"></span>
                                        </span>
                                        <span class="d-flex flex-column flex-1 ml-1">
                                    ...
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        ...
                                        <div class="d-flex flex-column flex-1">
                                            ...
                                            <div class="fs-sm d-flex align-items-center mt-2">
                                                <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('{{ asset('plugin/img/demo/avatars/avatar-a.png') }}'); background-size: cover;"></span>
                                                <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('{{ asset('plugin/img/demo/avatars/avatar-b.png') }}'); background-size: cover;"></span>
                                                <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('{{ asset('plugin/img/demo/avatars/avatar-c.png') }}'); background-size: cover;"></span>
                                                <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('{{ asset('plugin/img/demo/avatars/avatar-e.png') }}'); background-size: cover;"></span>
                                                <div data-hasmore="+3" class="rounded-circle profile-image-md mr-1">
                                                    <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('{{ asset('plugin/img/demo/avatars/avatar-h.png') }}'); background-size: cover;"></span>
                                                </div>
                                            </div>
            ...
            <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                ...
                <div class="dropdown-multilevel dropdown-multilevel-left" style="display: none">
                    ...
                    <div class="dropdown-menu">
                        <a href="javascript:void(0);" class="dropdown-item active" data-action="lang" data-lang="en">English</a>
                        <a href="javascript:void(0);" class="dropdown-item" data-action="lang" data-lang="ch">ខ្មែរ</a>
                    </div>
                </div>
                <div class="dropdown-divider m-0"></div>
                <a id="headerResetPasswordBTN" class="dropdown-item fw-500 pt-3 pb-3" href="javascript:void(0);" onclick="new function(){$('#layoutresetPasswordform #layoutresetpassword').val('');$('#layoutresetPasswordModal').modal();}">
