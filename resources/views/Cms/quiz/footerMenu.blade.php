            ...
            <div class="row menu_footer_wrapper">
                <div class="col-xl-4 col-lg-4">
                    <a href="{{ url(App::getLocale() == 'en' ? '/' : 'kh') }}">
                        <?php
                            $logo = '';
                            foreach ($menuData['menuFooterItems'] as $key => $value) { if($value->key == 'logo'){$logo = $value->image; }}
                        ?>
                    ...
                    <div class="row mt-3">
                        <div class="col-lg-12">
                            <ul style="display: grid;">
                                ...
                                @foreach($menuData['menuFooterItems'] as $menuFooterItem)
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <ul class="icon-group py-2">
                                @foreach($menuData['menuFooterItems'] as $key=>$menuFooterItem)
                ...
                <div class="col-xl-8 col-lg-8">
                    <div class="row">
                        ...
                        foreach ($menuData['bottomMenu'] as $i => $item) {
                            $externalLink = '';
                            $aClass = '';
                            $lClass = '';
