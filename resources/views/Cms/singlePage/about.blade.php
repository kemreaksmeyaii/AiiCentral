            ...
            <div class="row g-0 m-0" style="background-color:#F2BE1A;">
                <div class="col-lg-6" >
                    <div class="imageSection">
                        <img src="{{ asset('public/storage/photos/default/program.jpg') }}" data-src="{{ asset('public/storage/photos/addmission/aboutUsbg.jpg') }}" width="100%" alt="public/storage/photos/addmission/admission.jpg">
                    </div>
                </div>
