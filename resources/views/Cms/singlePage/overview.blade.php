...
@section('content')
    ...
    <div class="container-fluid p-0 m-0">
            ...
            <div class="row g-0 m-0" style="background-color:#467ca1;">
                <div class="col-lg-6" >
                    <div class="imageSection">
                        <img src="{{ asset('public/storage/photos/default/program.jpg') }}"  data-src="{{ asset('public/storage/photos/about/overviewinside.jpg') }}" width="100%" alt="public/storage/photos/about/overviewinside.jpg">
                    </div>
                </div>
