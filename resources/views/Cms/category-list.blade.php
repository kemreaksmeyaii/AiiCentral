        ...
        <div class="row justify-content-center">
            @foreach ($data as $key=>$value )
                <div class="col-lg-10" style="background-color: #f0f3f3; border-radius: 5px; margin: 8px; padding: 25px">
                    ...
                    <a class='btn btn-dark-purple' href='{{url(App::getLocale() == "en"?"/article-list":"/kh/article-list")."/".$value->id}}' style="float: right;">{{App::getLocale() == 'en'?'Show article':'បង្ហាញអត្តបទ'}}</a>
                </div>
            @endforeach
