...
@section('content')
    ...
    <div class="container-fluid bannerContent" style="background:url('{{ asset('public/storage/photos/publications/publications.jpg') }}'); ">
                                    ...
                                    <div class="box border">
                                        <a style="display:block;color:#333;text-decoration:none;" href="{{ url(App::getLocale() == 'en'?'articles/'.$value->slug_en :'kh/articles/'.$value->slug_en)}}">
                                            <div>
                                                <div>
                                                    <div>
                                                        <img style="object-fit:cover;" width="100%" height="100%" src="{{ asset('public/storage/photos/lazyloading/lazyloading-publications.jpg') }}"
                                                            data-src="{{ $value->thumbnail }}" alt="{{ $nameImage }}">
                                                    </div>
                                                </div>
                                                <div class="p-3">
                                                    <div class="text-center">
                                                        <h3 class="mb-3" style="font-size:1.1rem; font-weight:600;line-height:24px;">{{ Str::limit(App::getLocale() == 'en'?$value->title_en : $value->title_kh, 120) }}</h3> 
