...
<head>
    ...
    <!-- base css -->
    <link id="vendorsbundle" rel="stylesheet" media="screen, print" href="{{ asset('plugin/css/vendors.bundle.css') }}">
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('FrontEnd/Image/favicon.png') }}">
    ...
    <link rel="stylesheet" media="screen, print" href="{{ asset('plugin/css/notifications/sweetalert2/sweetalert2.bundle.css') }}">
...
<body>
    ...
    <div class="blankpage-form-field">
        <div
            ...
            <a href="javascript:void(0)" class="page-logo-link press-scale-down d-flex justify-content-between align-items-center">
                <div>
                <img src="{{ asset('public/storage/photos/logo/Aii-Window-to-the-World_New-logo-3.png') }}" alt="Aii Language Center Logo" aria-roledescription="logo"
