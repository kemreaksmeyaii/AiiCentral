<div class="col-xl-12">
    <div id="panel-1" class="panel">
        <div class="panel-hdr">
            <h2>
                Slides <span class="fw-300"><i>List</i></span>
            </h2>
        ...
        <div class="panel-container show">
            <div class="panel-content">
                ...
                <table id="datalist" class="table table-bordered table-hover table-striped w-100"
                    ...
                    <thead>
                        <tr>
                            <th style="text-align:center!important">Thumbnail</th>
                            <th style="text-align:center!important">Title</th>
                            <th style="text-align:center!important">Ordering</th>
...
<script>
    {
        ...
        function edit(id) {
            ...
            $('#holder').html(`<img src="${data.thumbnail}" alt="thumbnail" id="showThumbnail" style="height: 5rem;">`);
            $('#title_kh').val(data.title_kh);
            $('#title_en').val(data.title_en);
            $('#link_slide').val(data.link_slide);
        ...
        function update() {
            ...
            if (0 === 0) {
                $.ajax({
                    url: "{{ url('/api/admin/slide') }}/"+idEdit,
                    type: "PUT",
                    data: valueFil(),
                    beforeSend: function(xhr) {
                        blockagePage('Please Wait...');
