<div class="col-xl-12">
    <div id="panel-1" class="panel">
        <div class="panel-hdr">
            <h2>
                Video Embed <span class="fw-300"><i>List</i></span>
            </h2>
...
@include('AdminMenu.VideoEmbed.form')
<script>
    {
        var idEdit = null;
        ...
        function update() {
            ...
            if (0 === 0) {
                $.ajax({
                    url: "{{ url('/api/admin/videoEmbed') }}/" + idEdit,
                    type: "PUT",
                    data: valueFil(),
                    beforeSend: function(xhr) {
                        blockagePage('Please Wait...');
        ...
        function destroy(id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ url('/api/admin/videoEmbed') }}/" + id,
                        type: "DELETE",
                        beforeSend: function(xhr) {
                            blockagePage('Please Wait...');
                            xhr.setRequestHeader('Authorization', 'Bearer ' + AuthToken);
        ...
        function activeBtn(id) {
            if (0 === 0) {
                $.ajax({
                    url: "{{ url('/api/admin/videoEmbed/activeBtn') }}/" + id,
                    type: "GET",
                    beforeSend: function(xhr) {
                        xhr.setRequestHeader('Authorization', 'Bearer ' + AuthToken);
                    },
